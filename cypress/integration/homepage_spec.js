describe('Homepage', () => {
  ...
  it('shuld be able to see new shortened URL in DOM after submitting', () => {
    cy.get('form')
      .find('input').should('have.length', 2)
      .get('button').should('have.text', 'Shorten Please!')
      ...
      .get('p')
      .contains('https://images.unsplash.com/photo-1531898418865-480b7090470f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=')
  })

  // it('should be able to delete the url', () => {
  //   cy.get('form')
  //     .find('input').should('have.length', 2)
  //     .get('button').should('have.text', 'Shorten Please!')
  //     .get('input[name="title"]').type('Test 2')
